...
class GoalOverview extends React.Component {
  state = {
    ...
    series: [Math.round((Number(13561)/Number(86617))*100)]
  }
  render() {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Convertion Goal</CardTitle>
        ...
        <div className="d-flex mt-2">
          <div className="completed border-top border-right text-center w-50 py-1">
            <p className="mb-50">Visited</p>
            <p className="font-large-1 text-bold-600 mb-50">86,617</p>
          </div>
          <div className="in-progress border-top border-right text-center w-50 py-1">
            <p className="mb-50">Account Created</p>
