  ...
  let landingHTML=<>
    ...
    <div className="o-wrapper-l">
        <div className="hero flex flex-column">
            ...
            <div>
                <div className="actionText">Your Meeting name : <span className={copied?"username highlight copied":"username highlight"} onClick={()=>{showCopiedMessage()}}>{yourID}</span></div>
            </div>
            <div className="callBox flex">
                <input type="text" placeholder="Meeting Name" value={receiverID} onChange={e => setReceiverID(e.target.value)} className="form-input"/>
