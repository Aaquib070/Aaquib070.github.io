              ...
              <ModalFooter>
                <Button
                  ...
                  onClick={() => {
                    ...
                    console.log(todo)
                    setopen(false)
                    props.moveToTrash(todo._id, true)
                  }}
                >
                  Move To Trash
                </Button>
                ...
                <div id="options">
                  ...
                  >
                    {todo.isImportant && (
                      ...
                      >
                        <Star size={23} color={'white'} />
                      </div>
                    )}{' '}
                    {selectedFilter?.filter !== 'trashed' &&
                      ...
                      >
                        {
                          <Trash
                            size={23}
                            color={`${
                              todo.isTrashed ? 'white' : 'currentColor'
                            }`}
                            onClick={(e) => {
                              e.stopPropagation()
                              setopen(true)
        ...
        <div className="todo-app-list-wrapper h-100">
          <div className="todo-app-list h-100">
            ...
            {selectedFilter?.filter === 'trashed' && (
              <Button
                color="danger"
                style={{ width: '250px', margin: '10px', marginLeft: '30%' }}
                className="button-label"
                onClick={() => {
                  if (todosArr.length > 0)
                    todosArr.forEach((todo) => props.trashTask(todo))
                }}
              >
                <Trash size={23} color="white" /> Empty Trash Bin
              </Button>
            )}
            <PerfectScrollbar
